...
static void ShowDemoWindowWidgets(ImGuiDemoWindowData* demo_data)
{
    ...
    if (ImGui::TreeNode("Tree Nodes"))
    {
        ...
        if (ImGui::TreeNode("Advanced, with Selectable nodes"))
        {
            ...
            ImGui::CheckboxFlags("ImGuiTreeNodeFlags_Framed",            &base_flags, ImGuiTreeNodeFlags_Framed); ImGui::SameLine(); HelpMarker("Render frame with background (e.g. for CollapsingHeader)");
...
static void ShowExampleAppCustomRendering(bool* p_open)
{
    ...
    if (ImGui::BeginTabBar("##TabBar"))
    {
        ...
        if (ImGui::BeginTabItem("Render Channels"))
        {
            ImDrawList* draw_list = ImGui::GetWindowDrawList();
            {
